...
def getStats(fen, move):
    ...
    stockfish = Stockfish(parameters={"Threads": 3, "Minimum Thinking Time": 100, "Ponder": True})
...
try:
    if __name__ == "__main__" and sys.argv[1] == "-d":
        stockfish = Stockfish("Engines/stockfish_14_linux_x64/stockfish_14_x64")
        stockfish = Stockfish(parameters={"Threads": 1, "Minimum Thinking Time": 100, "Ponder": True})
